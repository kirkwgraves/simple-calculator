...
namespace SimpleCalculatorTests
{
    ...
    public class EvaluateTests
    {
        ...
        public void EvaluateProveICanSubtractTerms()
        {
            ...
            // Act
            double actual = subtraction_exp.EvaluateExpression(test_expression);
            double expected = 6;
        ...
        public void EvaluateProveICanMultiplyTerms()
        {
            ...
            // Act
            double actual = multiplication_exp.EvaluateExpression(test_expression);
            double expected = 40;
        ...
        public void EvaluateProveICanGetModulo()
        {
            ...
            // Act
            double actual = modulus_exp.EvaluateExpression(test_expression);
            double expected = 1;
